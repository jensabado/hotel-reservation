  ...
  <div class="booking_table d_flex align-items-center">
    ...
    <div class="container">
      <div class="banner_content text-center">
        ...
        <p>Effortless Hotel Room Reservations for Your Perfect Getaway Experience</p>
...
<section class="about_history_area section_gap">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        <img class="img-fluid" src="user/image/about_bg.jpg" alt="img">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="testimonial_slider owl-carousel">
      <div class="media testimonial_item">
        <img class="rounded-circle" src="user/image/testtimonial-1.jpg" alt="">
    ...
    <div class="row mb_30">
      <div class="col-lg-4 col-md-6">
        <div class="single-recent-blog-post">
          <div class="thumb">
            <img class="img-fluid" src="user/image/blog/blog-1.jpg" alt="post">
          </div>
          <div class="details">
            <div class="tags">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-recent-blog-post">
          <div class="thumb">
            <img class="img-fluid" src="user/image/blog/blog-2.jpg" alt="post">
          </div>
          <div class="details">
            <div class="tags">
              <a href="#" class="button_hover tag_btn">Travel</a>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-recent-blog-post">
          <div class="thumb">
            <img class="img-fluid" src="user/image/blog/blog-3.jpg" alt="post">
          </div>
          <div class="details">
            <div class="tags">
              <a href="#" class="button_hover tag_btn">Travel</a>
...
$(window).on('load', function() {
    if(localStorage.getItem('message')) {
        showAlert('success', 'Success!', localStorage.getItem('message'));
