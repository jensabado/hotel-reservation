        ...
        <form id="login_form">
          <div class="row mb-3 mt-2">
            <div class="col-12">
              ...
              <span class="text-danger errors" style="font-weight: 500; font-size: 12px;" id="login_id_error"></span>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
          ...
          <div class="row mb-2">
            <div class="col-12">
              <a href="<?= route_to('user.forgot-password.form') ?>" class="text-right" style="font-size: 12px;">Forgot
                Password?</a>
            </div>
          </div>
          <div class="row">
